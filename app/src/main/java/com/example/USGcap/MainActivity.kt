...
//            }
        ...
        val videoUrl = "http://192.168.0.10:5000/video_feed"
    ...
    private fun showOffDialog() {
        ...
        confirmTextView.text = "스프링클러를 끄시겠습니까?"
        ...
        yesButton.setOnClickListener {
            // '확인' 버튼을 클릭했을 때 동작
            turnOffPump()
            alertDialog.dismiss()  // 필요에 따라 다이얼로그 닫기
        }

        noButton.setOnClickListener {
            // '취소' 버튼을 클릭했을 때 동작 (아무 동작 없음)
            alertDialog.dismiss()  // 필요에 따라 다이얼로그 닫기
        }
    }

    private fun showOnDialog() {
        val inflater = layoutInflater
        val dialogView = inflater.inflate(R.layout.dialog_confirm, null)
        val builder = AlertDialog.Builder(this)
        builder.setView(dialogView)
        ...
        confirmTextView.text = "스프링클러를 켜시겠습니까?"
